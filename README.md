...
- SearchBar: receives all user input
  - textbox form/submit button
- Bio: user input information
  - UserName: user input name
  - UserImage: user input img
  - UserLinks: Tweets, Following, Followers
  - UserBioDescription: user input description
- PostsTable: displays and filters the data collection based on user input
  - user input to post/submit button
  - displays all users posts
- FriendRequests: displays friend requestions \* add friend request
